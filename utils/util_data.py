...
def load_data_cifar10(
    ...
    cifar10_train_ds = CIFAR10(dir_data, train=True, download=False, transform=transform)
    cifar10_test_ds = CIFAR10(dir_data, train=False, download=False, transform=transform)
